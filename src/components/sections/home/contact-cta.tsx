    ...
    >
      ...
      <div className="shell relative py-24 md:py-28 lg:py-36">
        <div className="mx-auto max-w-225 text-center">
          ...
          {/* Headline */}
          <h2 className="mx-auto mt-7 max-w-212.5 text-balance font-display text-[clamp(3rem,6vw,5.6rem)] font-extrabold leading-[0.97] tracking-[-0.055em]">
          ...
          <p className="mx-auto mt-7 max-w-152.5 text-[15px] leading-7 text-muted-foreground sm:text-base sm:leading-8">
            ...
            {siteConfig.socials.map(
              (social) => (
                <a
                  ...
                  className="group inline-flex items-center gap-1.5 text-sm font-medium text-muted-foreground transition-colors duration-300 hover:text-primary"
                >
                  {social.label}
                  <ExternalArrowIcon />
                </a>
